...
// GenerateIconFontCppHeaders.py for languages C and C++ from icons.yml for use
// with
...
#define ICON_FA_ARROW_DOWN_LEFT_AND_ARROW_UP_RIGHT_TO_CENTER                   \
  "\xee\x82\x92"                                          // U+e092
...
#define ICON_FA_ARROW_UP_RIGHT_AND_ARROW_DOWN_LEFT_FROM_CENTER                 \
  "\xee\x82\xa0"                                                      // U+e0a0
